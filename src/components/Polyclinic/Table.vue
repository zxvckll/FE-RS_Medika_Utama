...
export default {
  ...
  methods: {
    ...
    deletePolyclinic(id) {
      this.$emit("deletepolyclinic", id);
      this.showDeleteModal = false;
    },
    editPolyclinic(newData) {
      console.log(newData);
      this.$emit("editpolyclinic", newData);
      this.closeModal();
    },
    addPolyclinic(newData) {
      console.log(newData);
      this.$emit("addpolyclinic", newData);
      this.closeModal();
    },
  },
};
