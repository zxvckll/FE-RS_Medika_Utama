    ...
    >
      <thead>
        <tr class="bg-green-500 text-center font-bold">
          <th class="pt-2 pr-10">noRM</th>
          <th class="pt-2 pr-10">name</th>
          <th class="pt-2 pr-10">imageUrl</th>
          <th class="pt-2 pr-10">address</th>
          <th class="pt-2 pr-10">dateOfBirth</th>
          <th class="pt-2 pr-10">citizenship</th>
      ...
      <tbody>
        <tr
          ...
          class="border"
        >
          <td>{{ datta.noRM ? datta.noRM : "" }}</td>
          <td>{{ datta.name ? datta.name : "" }}</td>
          <td>{{ datta.imageUrl ? datta.imageUrl : "" }}</td>
          <td>{{ datta.address ? datta.address : "" }}</td>
          <td>{{ datta.dateOfBirth ? datta.dateOfBirth : "" }}</td>
          <td>{{ datta.citizenship ? datta.citizenship : "" }}</td>
